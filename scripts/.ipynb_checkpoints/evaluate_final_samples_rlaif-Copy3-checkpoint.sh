...
for dataset in foil	#filtered_polaris #  pascal50s #imgreward_test
do
    echo Data type: "$dataset"
    for context_dataset in foilv1.0_test_2017.json #yuwd #OID-rated-image-captions.v2.dev.alignment.tsv #VOCdevkit/VOC2010 #ImageReward/data 
    do
