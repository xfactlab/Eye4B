...
do
    ...
    do
        ...
        do
            ...
            --model_name_or_path "SNUMPR/vlm_sft_video_llava_13b" \
            --checkpoint_dir "/userhomes/namin/BarrierFree/vlm-rlaif/RLAIF/vlm_rm_13b_lora" \
