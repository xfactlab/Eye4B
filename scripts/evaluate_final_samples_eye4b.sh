...
do
    ...
    do
        ...
        for model_type in blip-s #blip-s #polos #pac-s #polos # qwen_rlaif-s_inst #longclip-s # qwen_rlaif-s_inst #llava_rlaif-s_inst #llava_rlaif-s #clip-s #llava_rlaif-s # longclip-s #polos #blip # contextclip # longclip # clip
        do
